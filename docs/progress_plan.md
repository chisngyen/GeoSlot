...
- [X] Thực hiện Literature Review về Vision Mamba, Slot Attention, và Graph trong CVGL
- [X] Đánh giá tính mới (Novelty) và đề xuất hệ thống
- [X] Chốt kiến trúc tổng thể

### Giai đoạn 2: Chuẩn bị Dữ liệu (Sắp tới)

- [X] Nhận cấu trúc thư mục dữ liệu từ Kaggle
- [X] Xây dựng Data Dataloaders/Transforms hỗ trợ nhiều bộ dataset khác nhau
- [X] Implement hàm đánh giá (Metrics/Evaluation)

### Giai đoạn 3: Triển khai Kiến trúc (Implementation)

- [X] Xây dựng Backbone Vision Mamba / VimGeo
- [X] Triển khai Adaptive Slot Attention
- [X] Triển khai Graph Mamba cho Lập luận Quan hệ Không gian
- [X] Thiết kế và cài đặt Sinkhorn Optimal Transport (AGOT) module
- [X] Cài đặt các hàm mất mát (DWBL, Symmetric InfoNCE, Dice Loss)
