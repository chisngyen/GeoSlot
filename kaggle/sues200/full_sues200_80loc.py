...
# Total losses: 12 (6 base + Proxy + EMA + AltConsist + MaskRecon + AltPred + Diversity)
# =============================================================================
...
def main():
    ...
    with open(os.path.join(CFG.OUTPUT_DIR, 'exp35_dpea_ga_results.json'), 'w') as f:
    ...
    best_ckpt_path = os.path.join(CFG.OUTPUT_DIR, 'exp35_dpea_ga_best.pth')
    ...
    with open(os.path.join(CFG.OUTPUT_DIR, 'exp35_tte_results.json'), 'w') as f:
